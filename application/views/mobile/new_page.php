...
<div ng-controller="agentSearchCtrl">
    <div class="group">
        <div class="img-group">
            <img src="<?php echo site_url('source/mobile/img/saian_logo.png');?>">
        </div>
        <div class="img-group">
    ...
    <div class="group butt" style="width: 100%;bottom: 0; margin: 0; margin-top: 20px">
        <div style="line-height: 50px;padding: 4px 12px 8px 12px; text-align: center;">
            <button class="radius4 button block submit-btn margin8 " style="width: 95%" ng-click="click('add_report/<?php echo time();?>', true)">
                <label>检测人信息登记</label>
            </button>
        </div>
    </div>
    <div class="group butt" style="width: 100%;bottom: 0; margin: 0;">
        <div style="line-height: 50px;padding: 4px 12px 8px 12px; text-align: center;">
            <button class="radius4 button block submit-btn margin8 " style="width: 95%" ng-click="click('search_report/<?php echo time();?>', true)">
                <label>检测报告查询</label>
            </button>
        </div>
    </div>
